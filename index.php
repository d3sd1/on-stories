						...
						<div class="header-row">
							<div class="header-column">
								<div class="header-logo">
									<a href="index.html">
										<img alt="Porto" width="82" height="40" src="img/logo-default-slim.png">
									</a>
								</div>
							</div>
							<div class="header-column">
					...
					<div id="revolutionSlider" class="slider rev_slider" data-plugin-revolution-slider data-plugin-options='{"sliderLayout": "fullscreen"}'>
						<ul>
							<li data-transition="fade">
								<img src="<?php echo $config['url.domain'] ?>/style/images/index_bg.jpg"  
									alt=""
								...
								<div class="tp-caption top-label"
									...
									data-start="500"
									style="z-index: 5"
									data-transform_in="y:[-300%];opacity:0;s:500;"><?php echo $lang['index.slide.title'] ?></div>
								...
								<div class="tp-caption main-label"
									...
									style="z-index: 5"
									data-mask_in="x:0px;y:0px;"><?php echo $lang['index.slide.subtitle'] ?></div>
								...
								<div class="tp-caption bottom-label"
									...
									data-start="2000"
									style="z-index: 5"
									data-transform_in="y:[100%];opacity:0;s:500;"><?php echo $lang['index.slide.desc'] ?></div>
								...
								<a class="tp-caption btn btn-lg btn-primary btn-slider-action"
									...
									data-transform_out="opacity:0;s:500;"
									style="z-index: 5"
									data-mask_in="x:0px;y:0px;"><?php echo $lang['index.slide.button'] ?></a>
							...
							<div class="blog-posts">
								...
								<article class="post post-large">
									<div class="post-video">
										<iframe src="https://www.youtube.com/embed/tN8ZyjXp4Gs" width="1280" height="720" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
									</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="recent-posts mb-xl">
										<h2><?php echo $lang['index.prefooter.wrtsmonthtxt'] ?></h2>
										<div class="row">
								...
								<div class="col-md-6">
									<h2><?php echo $lang['index.prefooter.pramonthtxt'] ?></h2>
									<div class="row">
										<div class="owl-carousel owl-theme mb-none" data-plugin-options='{"items": 1}'>
											<div>
												<div class="col-md-12">
